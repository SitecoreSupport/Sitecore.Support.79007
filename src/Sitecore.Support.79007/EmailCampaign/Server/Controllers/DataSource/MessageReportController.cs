namespace Sitecore.Support.EmailCampaign.Server.Controllers.DataSource
{
  ...
  [ServicesController("EXM.FixedMessageReport"), Sitecore.Support.EmailCampaign.Server.Filters.SitecoreAuthorize(new string[] { @"sitecore\ECM Advanced Users", @"sitecore\ECM Users" })]
